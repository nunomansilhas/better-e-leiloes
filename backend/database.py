...
class EventAiTipDB(Base):
    ...
    # Model info
    model_used: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)  # e.g., 'llama3.2:3b'
...
class AiPipelineStateDB(Base):
    ...
    Tracks which events have been queued/processed.
    """
    __tablename__ = "ai_pipeline_state"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    pipeline_name: Mapped[str] = mapped_column(String(50), unique=True, nullable=False)  # 'ai_tips'
